          ...
          function rt(e, n, s) {
            ...
            function V(t, e) {
              ...
              for (var a = 0; a < n.handles; a++)
                d.push(O(e, a)), (D[a] = a), x.push(W(i, t[a + 1]));
            }
            function R(t) {
              return (
    ...
    setTimeout(() => {
      ...
      (g = function () {
        ...
        function Ze(t, e, n, o) {
          ...
          var D = {
            ...
            isWithin: function (n, i) {
              var a = lt(n - e);
              return (
                A || (!m.rewind && !t.is(Re)) || (a = at(a, t.length - a)),
                a <= i
              );
            },
          };
        ...
        var Ue = "keydown",
          ...
          tn = Object.freeze({
            ...
            Layout: function (t, e, n) {
              ...
              function P() {
                (i = n.direction === Gt),
                  V(v, "maxWidth", tt(n.width)),
                  V(h, p("paddingLeft"), w(!1)),
                  V(h, p("paddingRight"), w(!0)),
                  x(!0);
              }
              function x(t) {
                var e,
              ...
              function D() {
                var t = y(0);
                return (t && parseFloat(V(t.slide, p("marginRight")))) || 0;
              }
              function E() {
              ...
              return {
                ...
                getPadding: function (t) {
                  return (
                    parseFloat(V(h, p("padding" + (t ? "Right" : "Left")))) || 0
                  );
                },
                isOverflow: E,
              };
            ...
            Move: function (t, e, a) {
              ...
              function L(n, i) {
                if (!t.is(Be)) {
                  ...
                  V(x, "transform", "translate" + g("X") + "(" + a + "px)"),
                    n !== a && l(Ot);
                }
              }
              function M(t, e) {
            ...
            Autoplay: function (t, e, n) {
              var i,
                ...
                s = o.bind,
                l = o.emit,
                u = Rt(n.interval, t.go.bind(t, ">"), function (t) {
                  var e = f.bar;
                  e && V(e, "width", 100 * t + "%"), l("autoplay:playing", t);
                }),
                c = u.isPaused,
                f = e.Elements,
                p = e.Elements,
            ...
            Drag: function (t, e, o) {
              ...
              function C(e) {
                if ((x.is(6) || (x.set(6), y("drag")), e.cancelable))
                  if (c) {
                    w.translate(r + W(e) / (z && t.is(Ve) ? 5 : 1));
                    var n = V(e) > 200,
                      i = z !== (z = N());
            ...
            LazyLoad: function (t, e, n) {
              ...
              function h(t, e) {
                var n = t[0],
                  i = t[1];
                K(i.slide, ze),
                  "error" !== e.type && (F(t[2]), R(n, ""), l(_t, n, i), l(jt)),
                  c && g();
              }
              function g() {
                p.length && v(p.shift());
        ...
        function an(t, e, n) {
          ...
          return {
            mount: function () {
              Vt(t).bind(s, "transitionend", function (t) {
                t.target === s && i && (c(), i());
              });
            },
            start: function (e, s) {
        ...
        var on = (function () {
            ...
            return (
              ...
              (u.destroy = function (t) {
                ...
                return (
                  i.is(e)
                    ? Vt(this).on(yt, this.destroy.bind(this, t))
                    : (I(
                        this._C,
                        function (e) {
